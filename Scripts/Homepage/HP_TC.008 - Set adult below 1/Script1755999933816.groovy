...
int decreaseAdult = 2
for (int i = 0; i < decreaseAdult; i++) {
	WebUI.click(findTestObject('Object Repository/Homepage/button_incrdecradultchildroom', [('pos') : 1]))}
...
// verifikasi occupancy tidak kurang dari 1 adult
assert aria.contains('1 adult')
