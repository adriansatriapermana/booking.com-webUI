...
int increaseChild = 10
for (int i = 0; i < increaseChild; i++) {
...
WebUI.verifyElementNotClickable(findTestObject('Object Repository/Homepage/button_incrdecradultchildroom', [('pos') : 4]))
...
assert aria.contains('2 adult')
assert aria.contains('10 children')
